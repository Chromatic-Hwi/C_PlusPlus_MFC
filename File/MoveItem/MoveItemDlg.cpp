...
// MoveItemDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "MoveItem.h"
#include "MoveItemDlg.h"
...
CMoveItemDlg::CMoveItemDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MOVEITEM_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMoveItemDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMoveItemDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CMoveItemDlg 메시지 처리기

BOOL CMoveItemDlg::OnInitDialog()
{
	...
	for (int i = 1; i <= 10; i++)
	{
		str.Format(L"Item%02d", i);
		m_left_list.InsertString(i -1, str);
	}
	/*
...
void CMoveItemDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CMoveItemDlg::OnQueryDragIcon()
{
...
void CMoveItemDlg::OnLbnSelchangeList2()
{
